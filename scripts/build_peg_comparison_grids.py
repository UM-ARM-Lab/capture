    ...
    *,
    ...
    for index, ((method, label), dynamic_duration) in enumerate(
        ...
        filters.append(
            ...
            f"crop=1290:726:90:180,scale={CELL_WIDTH}:{CELL_HEIGHT}:flags=lanczos,fps=30,"
    ...
    filters.append(
        ...
        "drawbox=x=958:y=0:w=4:h=ih:color=white@0.72:t=fill,"
        "drawbox=x=1918:y=0:w=4:h=ih:color=white@0.72:t=fill,"
        "drawbox=x=0:y=538:w=iw:h=4:color=white@0.72:t=fill,"
